...
MIN_ENGAGEMENT_BY_CATEGORY = {
    ...
    "market":     40,   # 噪音最大的一类。2026-07-26 从 25 提到 40（Lawrence 反馈
    "macro":      40,   # 成本涨得快），按本文件一贯的调参方向走——先提这两类，
                        # 不动 security/risk 这些抢先性优先的高价值类别。
}
...
MAX_ITEMS_PER_RUN = 150   # 2026-07-26 从 200 降到 150，同一轮成本控制的收紧，
                          # 配合上面 market/macro 阈值上调一起生效
